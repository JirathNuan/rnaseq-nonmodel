...
-m diamond \
--evalue 1e-5 \
-i 03_assembly/Trinity_2023-03-08.Trinity.fasta \
--no_file_comments \
--itype CDS \
--excel \
--output Cyanophora_emapper_20230307
```
...
```
-rw-r--r--  1 jiratchaya jiratchaya 20287555 Mar  8 22:54 Cyanophora_emapper_20230307.emapper.annotations
-rw-r--r--  1 jiratchaya jiratchaya  5060493 Mar  8 22:54 Cyanophora_emapper_20230307.emapper.annotations.xlsx
-rw-r--r--  1 jiratchaya jiratchaya  5333975 Mar  8 22:54 Cyanophora_emapper_20230307.emapper.hits
-rw-r--r--  1 jiratchaya jiratchaya  2528455 Mar  8 22:54 Cyanophora_emapper_20230307.emapper.seed_orthologs
```
...
blastn -db [database_of_interest] \
